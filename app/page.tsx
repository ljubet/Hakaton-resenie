        ...
        <div className="text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          >
            <div className="flex justify-center items-center gap-4">
              <span className="text-brand-teal font-lobster" style={{ fontFamily: 'Lobster, cursive' }} >СРЕЌА</span>
          ...
          <div className="mt-16">
            <h2 className="text-3xl font-bold text-brand-teal mb-8">Featured Podcast</h2>
